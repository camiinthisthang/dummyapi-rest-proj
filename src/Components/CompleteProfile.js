...
export default function CompleteProfile(props){
    ...
    const getFullProfile = async () => {
      ...
      console.log("am i trippin?", fullProfile.data); // prints the response no problem
      setUserInfo(fullProfile.data);
      console.log(userInfo) // prints null?? 
      // setUserInfo({
    ...
    const handleExpandClick = () => {
      ...
      const view = (userInfo === null || userInfo === undefined) ? null : <Card className={classes.root}>
      <CardHeader
        avatar={
